...
% My sincere condolences to anyone undergoing cognitive dissonance due to 
% the spelling of 'colour' in this document. - NP
...
% The function below exists to correct for any grid coordinate that is
% outside the bounds of a unit cell. It accepts any grid coordinate, and
% returns the grid coordinate *inside* the unit cell that matches that grid
% coordinate. For example, if the grid is discretized into 64 steps in a 
% given Cartesian direction (gridmax = 64), and we have a coordinate at 
% -30 (val = -30), this function will output a value of 34. If the 
% coordinate is 288, the function will output 32.
