...
|`hide_colorbars`| A boolean indicating whether to hide the colorbars on the plot. If set to true, the plot will not contain any colorbars. Default value is false.|
